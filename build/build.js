...
/***/ function(module, exports, __webpack_require__) {
	...
	App = (function() {
	  function App() {
	    ...
	    this.game = new Phaser.Game(600, 600, Phaser.AUTO, 'game', {
	  ...
	  App.prototype.preload = function() {
	    ...
	    this.game.load.tilemap('map_01', '/assets/map_01.json', null, Phaser.Tilemap.TILED_JSON);
	    this.game.load.spritesheet('sprites', '/assets/tiles.png', 8, 8, 16);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Map = (function() {
	  function Map(game) {
	    this.game = game;
	    this.update = bind(this.update, this);
	    this.findObjectsByType = bind(this.findObjectsByType, this);
	  ...
	  Map.prototype.makePlayer = function(object) {
	    this.player = new Player(this.game, this.map, object);
	    this.layers.objects.addChild(this.player.view);
	  ...
	  Map.prototype.isValidMove = function(x, y) {
	    ...
	    movePos.x += x;
	    movePos.y += y;
	    return this.mapData.layers[0].data[movePos.y][movePos.x].index !== 6;
	  };
...
/***/ function(module, exports) {
	...
	Player = (function() {
	  function Player(game, map, data) {
	    this.game = game;
	    this.map = map;
	    this.update = bind(this.update, this);
	    this.updateViewPosition = bind(this.updateViewPosition, this);
	    this.moveRelative = bind(this.moveRelative, this);
	    this.view = this.game.add.sprite(0, 0, 'sprites');
	    this.view.smoothed = false;
	    this.position = new Phaser.Point(data.x / options.tilesize, (data.y / options.tilesize) - 1);
	  ...
	  Player.prototype.updateViewPosition = function() {
